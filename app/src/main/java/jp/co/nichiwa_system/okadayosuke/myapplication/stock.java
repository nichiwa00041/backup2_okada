            ...
            public void onClick(View v) {
                ...
                alertGas.setPositiveButton("保存", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        SharedPreferences.Editor LastYear = pref.edit();

                        LastYear.putInt("last_stock_year", cal.get(Calendar.YEAR));
                        LastYear.putInt("last_stock_month", cal.get(Calendar.MONTH));
                        LastYear.putInt("last_stock_day", cal.get(Calendar.DAY_OF_MONTH));
