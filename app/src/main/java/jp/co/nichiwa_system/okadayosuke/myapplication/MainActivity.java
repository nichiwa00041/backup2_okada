...
public class MainActivity extends Activity {
    ...
    public static final float GRAPH_DENO_FOOD = 10.0f;
    public static final float GRAPH_DENO_STOCK = 10.0f;
...
*/
        ...
        btnSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentSetting.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.setting");
        ...
        btnStock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentStock.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.stock");
        ...
        btnFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentFood.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.food");
        ...
        btnMetarFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.food");
...
/*
        for(int i = 0; i < 12 ; i++) {
            for(int j = 0; j < 12; j++) {
                if ( (array[i].lastDay == sc[j].lastDay) && (sc[j].isFlg == false) ) {
                    array[i].name = sc[j].name;
                    sc[j].isFlg = true;
                    break;
                }
            }
...
*/
        ...
        int kodomositagi = 0;
        kodomositagi = pref.getInt("key_kodomositagi", kodomositagi);

        int kaichuudento = 0;
        kaichuudento = pref.getInt("key_kaichuudenntou", kaichuudento);

        int koppu = 0;
        koppu = pref.getInt("key_koppu", koppu);

        int utuwa = 0;
        utuwa = pref.getInt("key_utuwa", utuwa);

        int taoru = 0;
        taoru = pref.getInt("key_taoru", taoru);

        int rappu = 0;
        rappu = pref.getInt("key_rappu", rappu);

        int hukuro = 0;
        hukuro = pref.getInt("key_hukuro", hukuro);

        int spoon = 0;
        spoon = pref.getInt("key_spoon", spoon);

        int hasi = 0;
        hasi = pref.getInt("key_hasi", hasi);

        int denti = 0;
        denti = pref.getInt("key_denti", denti);

        int radio = 0;
        radio = pref.getInt("key_radio", radio);

        int kankiri = 0;
        kankiri = pref.getInt("key_kankiri", kankiri);

        int masuku = 0;
        masuku = pref.getInt("key_masuku", masuku);

        int juudennki = 0;
        juudennki = pref.getInt("key_juudennki", juudennki);

        int nebukuro = 0;
        nebukuro = pref.getInt("key_nebukuro", nebukuro);

        int bin  = 0;
        bin = pref.getInt("key_bin", bin);

        int omutu = 0;
        omutu = pref.getInt("key_omutu", omutu);
...
/**********************************************************************************/
        ...
        rateNOKAll += UsedFamilyStock( kaichuudento, setting, 1.0f, 1.0f, 1.0f);
        ...
        rateNOKAll += UsedFamilyStock( thisshu, setting, 1.0f, 1.0f, 3.0f);
        rateNOKAll += UsedFamilyStock( hukuro, setting, 1.0f, 1.0f, 1.0f);
        ...
        rateNOKAll += UsedOneStockOnlyTaoru( taoru, adult, kids, baby, setting);
        if(kids > 0) {
...
/**********************************************************************************/
        ...
        //  幼児は必要ないので無条件で０
        rateUAll += UsedOneStock( gunte, adult, kids, 0);
        rateUAll += UsedOneStock( nebukuro, adult, kids, 0);

        rateUAll += UsedFamilyStock( hue, setting, 1.0f, 1.0f, 1.0f);
        ...
        rateUAll += UsedFamilyStock( masuku, setting, 1.0f, 1.0f, 1.0f);
        rateUAll += UsedFamilyStock( juudennki, setting, 1.0f, 1.0f, 1.0f);
...
/**********************************************************************************/
        ...
        float   rateStockGraph = rateStockFinal;
        int     rateStockTotal = (int)( rateStockFinal * 100 );
        ...
        final int lastStockYear = pref.getInt("last_stock_year", cal.get(Calendar.YEAR));
        final int lastStockMonth = pref.getInt("last_stock_Month", cal.get((Calendar.MONTH)) + 1);
        final int lastStockDay = pref.getInt("last_stock_day", cal.get(Calendar.DAY_OF_MONTH));

        TextView txtLastStock = (TextView) findViewById(R.id.last_stock);
        txtLastStock.setText(lastStockYear + "年" + lastStockMonth + "月" + lastStockDay + "日");
        ...
        TextView strRateStock = (TextView) findViewById(R.id.percent_stock);
        strRateStock.setText("" + rateStockTotal);
        ...
        ImageView graphRight = (ImageView) findViewById(R.id.graphRight);
        if (rateStockGraph < (1 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph0);
        } else if (rateStockGraph < (2 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph1);
        } else if (rateStockGraph < (3 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph2);
        } else if (rateStockGraph < (4 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph3);
        } else if (rateStockGraph < (5 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph4);
        } else if (rateStockGraph < (6 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph5);
        } else if (rateStockGraph < (7 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph6);
        } else if (rateStockGraph < (8 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph7);
        } else if (rateStockGraph < (9 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph8);
        } else if (rateStockGraph < (10 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph9);
        } else if (rateStockGraph == (10 / GRAPH_DENO_STOCK)) {
            graphRight.setImageResource(R.drawable.rightgraph10);
        }
                ...
                public void onClick(View v) {
                    ...
                    alertReRice.setPositiveButton("保存", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent();
                            intent.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.MainActivity");
...
/*************************************************************************************************/
    ...
    public void func5(SampleClass x0,SampleClass x1,SampleClass x2,SampleClass x3,
        ...
        intId[0] = R.id.limit_food1;
        intId[1] = R.id.limit_food2;
        intId[2] = R.id.limit_food3;
        intId[3] = R.id.limit_food4;
        intId[4] = R.id.limit_food5;
        intId[5] = R.id.limit_food6;
        intId[6] = R.id.limit_food7;
        intId[7] = R.id.limit_food8;
        intId[8] = R.id.limit_food9;
        intId[9] = R.id.limit_food10;
        intId[10] = R.id.limit_food11;
        intId[11] = R.id.limit_food12;
        ...
        for(int i = 0; i < MAX_FOODS_CATEGORY-1 ; i++){
            for(int j = MAX_FOODS_CATEGORY -i - 1 ; j > i ; j--){
                if(array[j].lastDay < array[j-1].lastDay){
                    ...
                    array[j -1].id = intId[k];
//                    k++;
//                    for(int l = k ; l < MAX_FOODS_CATEGORY; l++){
//                        array[l].id = intId[k];
//                    }
                }
            }
...
//    rateOverKids = CalRateForOverKids(okAll, fBaby, adult, kids, baby, setting);
    public float getRateFoods(float food, int adult, int kids, int set) {
        //  設定の人数の合計値。
