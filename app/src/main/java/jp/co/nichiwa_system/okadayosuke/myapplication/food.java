    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentHome.setClassName("jp.co.nichiwa_system.okadayosuke.myapplication", "jp.co.nichiwa_system.okadayosuke.myapplication.MainActivity");
        ...
        int setting = pref.getInt("key_setting", 0);

        int limit = 0;
        limit = pref.getInt("key_limit", limit);
